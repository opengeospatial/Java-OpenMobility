 ...
 * @source $URL: http://svn.osgeo.org/geotools/trunk/modules/library/main/src/main/java/org/geotools/gml/SubHandler.java $
    ...
    protected int getSRID(){
        ...
        try {
        	...
        	try {
        		...
        		return 0; // probably some really complicated OGC SRS	
        	}
