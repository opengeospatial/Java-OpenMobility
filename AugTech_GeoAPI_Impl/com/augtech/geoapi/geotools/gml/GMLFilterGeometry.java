 ...
 * @source $URL: http://svn.osgeo.org/geotools/trunk/modules/library/main/src/main/java/org/geotools/gml/GMLFilterGeometry.java $
...
public class GMLFilterGeometry extends org.xml.sax.helpers.XMLFilterImpl  implements GMLHandlerGeometry {
    ...
    public void geometryStart(String localName, org.xml.sax.Attributes atts)
        ...
        for (int i = 0; i < atts.getLength(); i++) {
            ...
            if (NAME.toLowerCase().contains("srsname")) {
                srs = atts.getValue(i);
            }
        }        
